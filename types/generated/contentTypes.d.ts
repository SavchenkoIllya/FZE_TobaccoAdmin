...
export interface ApiCatalogueSectionCatalogueSection
  ...
  attributes: {
    close_filter_text: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Close'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    filter_items: Schema.Attribute.Component<'shared.filter-item', true>;
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    work_status: Schema.Attribute.Enumeration<
      ['read', 'unread', 'pending', 'answered']
    > &
      Schema.Attribute.DefaultTo<'unread'>;
  };
}

export interface ApiPillarSectionPillarSection extends Struct.SingleTypeSchema {
  collectionName: 'pillar_sections';
  info: {
    displayName: 'Pillar Section';
    pluralName: 'pillar-sections';
    singularName: 'pillar-section';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pillar-section.pillar-section'
    >;
    pillars_list: Schema.Attribute.Component<'shared.pillar', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blend: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }> &
      Schema.Attribute.DefaultTo<'American blend'>;
    brand: Schema.Attribute.Relation<'oneToOne', 'api::brand.brand'>;
    category: Schema.Attribute.Relation<'oneToOne', 'api::category.category'>;
    cigarette_length: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    filter_length: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::product.product'
    >;
    nicotine: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    tobacco_length: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProductionSectionProductionSection
  extends Struct.SingleTypeSchema {
  collectionName: 'production_sections';
  info: {
    displayName: 'Production Section';
    pluralName: 'production-sections';
    singularName: 'production-section';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::production-section.production-section'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSectionsMetaSectionsMeta
  extends Struct.CollectionTypeSchema {
  collectionName: 'sections_metas';
  info: {
    displayName: 'Sections Meta';
    pluralName: 'sections-metas';
    singularName: 'sections-meta';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiUploadItemUploadItem extends Struct.CollectionTypeSchema {
  collectionName: 'upload_items';
  info: {
    displayName: 'Upload item';
    pluralName: 'upload-items';
    singularName: 'upload-item';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::pillar-section.pillar-section': ApiPillarSectionPillarSection;
      'api::product-card.product-card': ApiProductCardProductCard;
      'api::product.product': ApiProductProduct;
      'api::production-section.production-section': ApiProductionSectionProductionSection;
      'api::sections-meta.sections-meta': ApiSectionsMetaSectionsMeta;
      'api::subscriber.subscriber': ApiSubscriberSubscriber;
      'api::upload-item.upload-item': ApiUploadItemUploadItem;
